# Generated by Powerlevel10k configuration wizard on 2025-08-26 at 14:31 EDT.
...
# slanted separators, slanted heads, blurred tails, 2 lines, solid, left frame,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=13
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_BACKGROUND=200
